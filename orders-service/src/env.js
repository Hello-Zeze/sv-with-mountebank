class Environment {    
    static canRun(){
        ...
        if(process.env.COUCHBASE_ORDERS_BUCKET === undefined){
            console.error('COUCHBASE_ORDERS_BUCKET not set.');
            return false;
        }
        ...
        console.log(`COUCHBASE_ORDERS_BUCKET: ${process.env.COUCHBASE_ORDERS_BUCKET}`);
