class Environment {    
    static canRun(){
        ...
        if(process.env.COUCHBASE_SHOPPINGCART_BUCKET === undefined){
            console.error('COUCHBASE_SHOPPINGCART_BUCKET not set.');
            return false;
        }
        ...
        console.log(`COUCHBASE_SHOPPINGCART_BUCKET: ${process.env.COUCHBASE_SHOPPINGCART_BUCKET}`);
